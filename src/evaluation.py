...
def run_evaluation(
    ...
    if use_deepeval:
        ...
        # Add hyperparameters if we're logging to Confident AI
        if log_to_confident:
            eval_params["hyperparameters"] = {
                "model": solution_model or os.getenv("SOLUTION_MODEL", "openai:gpt-4o"),
                "prompt_template": "Mathematical problem-solving with LLM-as-judge evaluation",
